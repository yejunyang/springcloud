package ai.yunxi.kafka.consumer;
...
public class OffsetConsumer {
    public static void main(String[] args) {
        ...
        consumer.assign(Arrays.asList(new TopicPartition("Topic-02", 0)));
        consumer.seekToBeginning(Arrays.asList(new TopicPartition("Topic-02", 0)));
